...
class PrOptimizer:
    ...
    def analyze_pr(self) -> Task:
        return Task(
            config=self.tasks_config["analyze_pr"], output_file="analysis_report.md"
        )
    ...
    def crew(self) -> Crew:
        ...
        return Crew(
            ...
            verbose=True,
            max_retry_limit=3,  # Add retry limit
            respect_context_window=True,  # Ensure context management
            planning=True,
            memory=True,
